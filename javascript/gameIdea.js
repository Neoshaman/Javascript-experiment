...
var GameLevel			= [" open world ", " linear ", " non linear", " corridor ", 
							...
							" sandbox ", " multi ending ", " branching "]
var GameGenre			= ["immersive sim","story","roguelike","beat'm up",
							...
							"social","Wrpg","Jrpg","Crpg","metroidvania", "collecthon"];
function gametype() {
...
var StorySpace			= ["external process","external state","internal state","internal process"];//["event pattern","physical space","mindset","behavior pattern"];//(>>internal/external + process/state) //attitude -> mindset, event -> activity
